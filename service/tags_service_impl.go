...
type TagsServiceImpl struct {
	TagsRepository respository.TagsRepository
	validate       *validator.Validate
}

func NewTagsServiceImpl(tagRepository respository.TagsRepository, validate *validator.Validate) TagsService {
